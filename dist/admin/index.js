...
const PluginIcon = () => /* @__PURE__ */ jsxRuntime.jsx(icons.PinMap, {});
var map;
try {
  map = Map;
} catch (_) {
...
const index = {
  register(app) {
    app.customFields.register({
      ...
      pluginId: PLUGIN_ID,
      type: "json",
      // the field will be stored as a json
      intlLabel: {
      ...
      intlDescription: {
        ...
        defaultMessage: "Allows to save and manage geographic locations, supporting latitude, longitude"
      },
      default: 12,
      isResizable: true,
      icon: PluginIcon,
      components: {
        Input: async () => Promise.resolve().then(() => require("../_chunks/Input-DkedwhdP.js"))
      },
      options: {
        base: [
          /*
              ...
              // Add settings items to the section
              {
                ...
                */
                intlLabel: {
                  ...
                  defaultMessage: "Only one GeoJSON field is allowed per content type"
                },
                name: "options.info",
                type: "checkbox",
                value: "ok",
